...
describe('Vote', () => {
    ...
    it('notifies users when a client is disconnected', async () => {
    ...
    it('notifies user that client is already banned if voting threshold is already met', async () => {
    ...
    it('notifies user that they already voted', async () => {
        getListeningClientsStub.returns(1); // 1 client listening on socket
