...
import { AppModule, TestAppModule } from './app.module';
...
async function bootstrap() {
    ...
    console.log(process.env.TWITCH_CALLBACK_URL_USER);
    ...
    // }
    // todo remove testapp module
    const app = await NestFactory.create<NestExpressApplication>(TestAppModule, { logger: ['log', 'error', 'warn'] });
